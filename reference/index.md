...
Functions for trimming the start and/or end of a deployment across all
parameters at once.
...
Functions for correcting instrument drift in continuous monitoring data.
...
Runs the bulk removal, drift correction, and flag-review editors in
sequence through a single launcher.
