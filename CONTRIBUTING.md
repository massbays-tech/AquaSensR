...
This outlines how to propose a change to AquaSensR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("massbays-tech/AquaSensR", fork = TRUE)`.
...
Code of
Conduct](https://massbays-tech.github.io/AquaSensR/CODE_OF_CONDUCT.md).
