...
2. **QC threshold metadata**: parameter-specific thresholds used by the four QC checks (gross range, spike, rate of change, and flatline).
...
5. **Numeric columns**: all columns except `Parameter` contain only numeric or missing values.
